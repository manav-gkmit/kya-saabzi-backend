...
async def remove_household_member(
    ...
    if household.admin_id != user.id:
        raise HouseholdAccessDeniedError("Only the household admin can remove members.")

    if member_id == user.id:
        raise ValidationError("You cannot remove yourself. Use the /leave endpoint instead.")
